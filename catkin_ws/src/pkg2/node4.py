...
class PublisherNode:
	def __init__(self):
		...
		self.publisher = rospy.Publisher('pb4', Float32, queue_size=10)
		# Subscriber that listens to processed data
		rospy.Subscriber('pb3', Float32, self.subscriber_callback)
	...
	def publish_data(self):
		# Publish the data to the topicrospy.loginfo("Publisher publishing data: %s" % self.data)
